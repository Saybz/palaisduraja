...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen w-screen px-10 font-body bg-gray-50 flex flex-col items-center">
      ...
      <section id="about" className=" flex-col w-full max-w-main mb-40">
      ...
      <section id="menu" className="max-w-main w-full mb-40">
        <h2 className="relative before:absolute before:-bottom-4 before:left-0 before:rounded-sm before:w-20 before:h-[2px] before:bg-primary font-head font-light text-3xl underline-offset-2 mb-20">
          Carte & Menus
        </h2>
      ...
      <section id="infos" className="w-screen py-40 bg-slate-200">
        <div className="max-w-main w-full mx-auto">
          ...
          <div className="w-full flex justify-between mb-8 px-10">
      ...
      <section id="contact" className="max-w-main w-full my-40">
        ...
        <div className="flex">
          <div className="1/3 p-16 bg-white rounded">
            ...
            <ul className="pl-3 border-l flex-col border-primary">
              <li className="mb-3">A 8 min de la gare</li>
              <li className="mb-3">200m de la Loire</li>
              <li className="mb-3">300m de la cathédrale Saint gatien</li>
              <li className="mb-3">Débouche sur la rue Nationale</li>
            </ul>
          </div>
